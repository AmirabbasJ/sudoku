...
export const ThemeCtx = createContext<ThemeCtx | null>(null) as React.Context<ThemeCtx>;

export const ThemeCtxProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  const [theme, setTheme] = useState<ThemeType>(() => getPersistentTheme() ?? getPreferTheme());
